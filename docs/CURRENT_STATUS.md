...
**Last updated:** 2026-08-24 (H13D resolution-aware curve rasterization exists; H12 compact hub remains the current closeout at `STITCHING_CONTROL_BLOCKED`; L5 remains `parent_incomplete`)
