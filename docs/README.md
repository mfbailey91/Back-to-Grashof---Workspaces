...
| [methods/R3A_H12_DIRECT_COMPARISON_METRIC_REPAIR.md](methods/R3A_H12_DIRECT_COMPARISON_METRIC_REPAIR.md) | ACTIVE REPAIR | Grid-local strict Hausdorff, boundary exclusion, reseed vocabulary, and semantic closeout recomputation |
