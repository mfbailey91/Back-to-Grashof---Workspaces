...
<table>
  ...
  <tr>
    ...
    <td>Hardened source-parent infrastructure; R3A five-point kernels and H0–H12 evidence law; frozen full-mode closeout <code>STITCHING_CONTROL_BLOCKED</code>; reconstruction not accepted; fixed-axis UUUR still rejected as an h=c equivalence</td>
    <td>Source h=c stitching control; accepted source-derived child reconstruction</td>
  </tr>
  <tr>
...
<div class="cap-grid">
  ...
  <div class="cap">
    ...
    <p>R3A five-point hub: <a href="l5_reconstruction/r3a/index.html">l5_reconstruction/r3a/index.html</a> — implemented kernels (oracle, direct IK, h=c control, UURU leaves). Frozen full-mode closeout is <code>STITCHING_CONTROL_BLOCKED</code>. Reconstruction is not accepted.</p>
...
<ul>
  <li>Hub: <a href="l5_reconstruction/r3a/index.html">l5_reconstruction/r3a/index.html</a> (full-mode <code>STITCHING_CONTROL_BLOCKED</code>; reconstruction not accepted)</li>
...
<table>
  ...
  <tr>
    ...
    <td>implemented kernels; full-mode closeout <code>STITCHING_CONTROL_BLOCKED</code>; reconstruction not accepted</td>
